...
const Signup = () =>{
    ...
    const handleSingup = (event) => {
        ...
        if (password.current.value !== confirmPassword.current.value) {
            ...
            fetch(
                "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyA1SHrUNAKICcPfRPDf8RigOErGQywebfk",
                {
                    method: "POST",
    ...
    return(
        ...
        <form onSubmit={handleSingup} className="form">
                        ...
                        <div className="row">
                            ...
                            <div className="col-75"> <input type="text" id="lname" name="Password" ref={confirmPassword} placeholder="Confirm Password.." /> </div>
                        </div>
                        <br />
                        <div>
